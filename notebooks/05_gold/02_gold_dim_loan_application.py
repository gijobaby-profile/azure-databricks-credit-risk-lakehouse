...
# MAGIC %md
# MAGIC # Build dim_loan_application
...
entity_name = "dim_loan_application"
target_table_full_name = f"{catalog_name}.gold.dim_loan_application"
...
log_file_path = (
    ...
    f"pipeline/gold/dim_loan_application/{business_dt}/{pipeline_run_id}.log"
)
logger = get_logger(name=f"gold_dim_loan_application", log_file_path=log_file_path)

config_for_error = {
    "entity_name": entity_name,
    "source_system": "home_credit",
    "source_path": "silver.conformed_loan_application",
